...
export default function BlogBanner() {
    const title = "Dissertation ASSIGNMENT BLOG"
        ...
        <div>
            <div className='blog-banner py-5 mb-5 '>
                ...
                <div className="container position-relative">
                    <p className='text-white pb-4 d-none d-sm-block'><Link to="/" className='text-white text-decoration-none'>Home</Link> <small><i className="fa-solid fa-chevron-right"></i></small> Blogs</p>
